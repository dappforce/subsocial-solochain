...
use log::info;
use subsocial_runtime::{Block, RuntimeApi};
...
const DEFAULT_PARACHAIN_ID: u32 = 2100;
...
fn load_spec(
    ...
    Ok(match id {
        ...
        "staging" => Box::new(chain_spec::subsocial_staging_config(para_id)?),
...
impl SubstrateCli for Cli {
    ...
    fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
        load_spec(id, self.run.parachain_id.unwrap_or(DEFAULT_PARACHAIN_ID).into())
    }
    ...
    match &cli.subcommand {
        ...
        Some(Subcommand::ExportGenesisState(params)) => {
            ...
            let block: Block = generate_genesis_block(&load_spec(
                ...
                params.parachain_id.unwrap_or(DEFAULT_PARACHAIN_ID).into(),
            )?)?;
        ...
        None => {
            ...
            runner.run_node_until_exit(|config| async move {
                ...
                let id = ParaId::from(cli.run.parachain_id.or(para_id).unwrap_or(DEFAULT_PARACHAIN_ID));
